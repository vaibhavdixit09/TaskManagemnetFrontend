...
const UpdateTaskModal = ({ task, closeModal, updateTask }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-50 my-2">
      <div className="bg-gray-800 text-white rounded-lg shadow-lg overflow-hidden w-11/12 md:w-1/2 lg:w-2/3">
